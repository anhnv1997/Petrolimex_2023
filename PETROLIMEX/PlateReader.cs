...
namespace iPGSTools
{
    public class PlateReader
    {
        ...
        public static PlateReaderResult Read(string postUrl, string filePath, string regions, string token)
        {
            ...
            {
                LogHelperv2.Logger_CONTROLLER_Error($"Exception Read ex = {ex}", LogHelperv2.SaveLogFolder);
                return null;
            }
        }
        ...
        public static PlateReaderResult Read(string postUrl, byte[] data, string token)
        {
            try
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    using (var reader = new System.IO.StreamReader(response.GetResponseStream(), encoding))
                    {
                        ...
                        {
                            LogHelperv2.Logger_CONTROLLER_Error($"Exception Read2 ex = {ex}", LogHelperv2.SaveLogFolder);
                        }
                    }
                    return result;
                }
            ...
            {
                LogHelperv2.Logger_CONTROLLER_Error($"Exception Read 2 ex = {ex}", LogHelperv2.SaveLogFolder);
                return null;
            }
        }
        ...
        public static byte[] GetByteArray(Image image)
        {
            ...
            {
                LogHelperv2.Logger_CONTROLLER_Error($"Exception GetByteArray ex = {ex}", LogHelperv2.SaveLogFolder);
        ...
        public static Image GetImage(byte[] bytearray)
        {
            ...
            {
                LogHelperv2.Logger_CONTROLLER_Error($"Exception GetImage2 ex = {ex}", LogHelperv2.SaveLogFolder);
